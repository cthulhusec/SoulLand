        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            switch (switchCase)
            {
                ...
                case 5:
                    ...
                    break;
                case 6:
                    spriteBatch.DrawString(mainTextFont, "Kill the Boss on Each Level", new Vector2((game.baseScreenSize.X / 2) - (mainTextFont.MeasureString("Kill the Boss on Each Level").X / 2), game.baseScreenSize.Y / 2 - 25), Color.AntiqueWhite);
                    spriteBatch.DrawString(mainTextFont, "to Gain the Key that Opens the Final Door", new Vector2((game.baseScreenSize.X / 2) - (mainTextFont.MeasureString("to Gain the Key that Opens the Final Door").X / 2), game.baseScreenSize.Y / 2 + 25), Color.AntiqueWhite);
                    break;
                case 7:
